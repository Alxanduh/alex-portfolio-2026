...
**Home page grid:** Projects auto-layout in a repeating cycle: pair-a (45/55, 1:1), solo (16:9), pair-b (55/45, 1:1), solo (16:9). 6 projects per cycle. Just set `showOnHome: true` and `homeOrder`.
