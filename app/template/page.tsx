    ...
    <main>
      ...
      <div className="site-container" style={{ paddingTop: "clamp(140px, 12vw, 200px)", paddingBottom: "var(--space-xl)" }}>
        ...
        <p className="text-big" style={{ color: "var(--color-muted)" }}>
          Home page design system &mdash; typography, color, spacing &amp; components
        </p>
      </div>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        <div className="rule" style={{ marginBottom: "var(--space-md)" }} />
        <p className="label" style={{ marginBottom: "var(--space-sm)" }}>Typography &mdash; Large</p>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-lg)" }}>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .hero-title &mdash; 500 &mdash; clamp(48px, 19.5vw, 375px) &mdash; hero banner
            </p>
          ...
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .intro-heading / .works-heading &mdash; 500 &mdash; clamp(48px, 8.54vw, 164px) &mdash; section headings
            </p>
            <p className="intro-heading" style={{ margin: 0 }}>Studio Schultz</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .accent-heading &mdash; 500 &mdash; clamp(36px, 10.5vw, 232px) &mdash; philosophy band
            </p>
            <p className="accent-heading" style={{ margin: 0 }}>What works</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .footer-col-label &mdash; 500 &mdash; clamp(32px, 5vw, 96px) &mdash; footer column headings
            </p>
            <p className="footer-col-label" style={{ margin: 0 }}>Explore</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .footer-col-link &mdash; 400 &mdash; clamp(32px, 5vw, 96px) &mdash; footer links
            </p>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        <div className="rule" style={{ marginBottom: "var(--space-md)" }} />
        <p className="label" style={{ marginBottom: "var(--space-sm)" }}>Typography &mdash; Body</p>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .intro-body-text &mdash; 500 &mdash; clamp(14px, 1.25vw, 24px) &mdash; intro paragraph
            </p>
          ...
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .marquee-text &mdash; 500 &mdash; clamp(40px, 16.5vw, 320px) &mdash; scrolling marquee
            </p>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        <div className="rule" style={{ marginBottom: "var(--space-md)" }} />
        <p className="label" style={{ marginBottom: "var(--space-sm)" }}>Typography &mdash; Labels</p>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .section-label-text &mdash; 600 &mdash; clamp(10px, 0.9375vw, 18px) &mdash; above-rule section labels
            </p>
          ...
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .footer-label &mdash; 600 &mdash; clamp(10px, 0.9375vw, 18px) &mdash; footer rule labels
            </p>
            <p className="footer-label" style={{ margin: 0 }}>The Footer</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .footer-coords &mdash; 600 &mdash; clamp(9.5px, 0.82vw, 15.5px) &mdash; footer coordinates (optically sized)
            </p>
            <p className="footer-coords" style={{ margin: 0 }}>39.7548&deg; N  104.9723&deg; W</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .footer-bottom-text &mdash; 600 &mdash; clamp(10px, 0.9375vw, 18px) &mdash; below marquee credits
            </p>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        <div className="rule" style={{ marginBottom: "var(--space-md)" }} />
        <p className="label" style={{ marginBottom: "var(--space-sm)" }}>Typography &mdash; Card Meta</p>
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .card-label &mdash; 500 &mdash; clamp(10px, 0.625vw, 12px) &mdash; category tags
            </p>
            <p className="card-label" style={{ margin: 0 }}>Branding &bull; UI &bull; UX</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .card-title &mdash; 500 &mdash; clamp(14px, 1.04vw, 20px) &mdash; project name
            </p>
            <p className="card-title" style={{ margin: 0 }}>Amount</p>
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>
              .card-desc &mdash; 400 &mdash; clamp(11px, 0.73vw, 14px) &mdash; project description
            </p>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>.rule &mdash; rgba(255,255,240, 0.2)</p>
            <div className="rule" />
          </div>
          <div>
            <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 8 }}>.rule-solid &mdash; #fffff0</p>
      ...
      <section className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        ...
        {/* Project Pair */}
        <p style={{ fontSize: 12, color: "var(--color-muted)", marginBottom: 16 }}>Project Pair &mdash; 50/50 split (.project-pair) &mdash; 4:3 images</p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {[
            ...
            <div key={token} style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
              ...
              <p style={{ fontFamily: "monospace", fontSize: 13, color: "var(--color-muted)", margin: 0 }}>{value} &mdash; {use}</p>
            </div>
          ))}
        </div>
      </section>
