...
export default function Footer() {
  return (
    <footer>
      <div className="site-container" style={{ paddingBottom: "var(--space-xl)" }}>
        ...
        <div className="footer-columns" style={{ paddingTop: "var(--space-xl)" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
            <h4 className="heading-accent" style={{ fontSize: "clamp(2.5rem, 7.5vw, 7.25rem)", lineHeight: 1.14 }}>
              Explore
            </h4>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
            <h4 className="heading-accent" style={{ fontSize: "clamp(2.5rem, 7.5vw, 7.25rem)", lineHeight: 1.2 }}>
              Let&apos;s chat
            </h4>
      ...
      {/* Marquee — two identical halves, 6 items each for full viewport coverage */}
